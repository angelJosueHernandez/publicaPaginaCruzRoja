...
export default function Politicas() {
    ...
    return (
        <div className="max-w-5xl mx-auto p-6 ">
            <h2 className="text-3xl font-bold text-red-700 mb-4">Aviso de Privacidad</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-red-600 mb-2">¿Para qué fines utilizaremos sus datos personales?</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-red-600 mb-2">Consentimiento para Fines Secundarios</h2>
            <p className="mb-4">
            ...
            <form className="mb-6">
                <p className="mb-2 font-semibold">No consiento que mis datos personales se utilicen para los siguientes fines:</p>
            ...
            <h2 className="text-2xl font-semibold text-red-600 mb-2">Negativa y Datos Personales</h2>
            <p className="mb-4">
                La negativa para el uso de sus datos personales para estas finalidades no podrá ser un motivo para que le neguemos los servicios y productos que solicita o contrata con nosotros.
            </p>

            <h2 className="text-2xl font-semibold text-red-600 mb-2">Datos Personales Sensibles</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-red-600 mb-2">Transferencias con Consentimiento</h2>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold text-red-500">¿Cómo puede acceder, rectificar o cancelar sus datos personales, u oponerse a su uso?</h3>
            <p className="mb-4">
